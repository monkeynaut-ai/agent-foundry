"""Tests for CapabilityStack model."""

from agent_foundry.acp.capability_stack import CapabilityStack
from agent_foundry.acp.protocol import MarkerMapping


class TestCapabilityStack:
    ...
    def test_given_stack_when_serialized_then_round_trips(self):
        ...
        restored = CapabilityStack.model_validate(data)
