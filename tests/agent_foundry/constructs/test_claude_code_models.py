...
class TestClaudeModel:
    def test_members_are_strings(self):
        from agent_foundry.constructs import ClaudeModel
...
class TestListClaudeModels:
    def test_returns_list_of_strings(self):
        ...
        with patch("agent_foundry.constructs.claude_code.anthropic.Anthropic") as mock_client_cls:
...
class TestClaudeEffort:
    def test_members_are_strings(self):
        from agent_foundry.constructs import ClaudeEffort
...
class TestPublicAPI:
    def test_importable_from_constructs(self):
        from agent_foundry.constructs import ClaudeEffort, ClaudeModel, list_claude_models
